...
const Footer = () => {
    return (
        <footer className="container bg-rgba(31, 31, 31, 1) text-white pt-2 text-sm md:text-base font-serif footer-container">
            <div className=" p-6 flex justify-between text-gray-300 relative" >
                {/* Левая часть */}
                <div className="mr-40">
                    ...
                    <h3 className="text-lg font-semibold mt-6">Присоединяйтесь</h3>
                    <div className="flex gap-4 mt-2">
                        <a href="https://www.instagram.com/dh_studio/" className="text-2xl p-2 rounded-full border border-[1.5px] border-[rgba(225, 222, 206, 1)] text-[rgba(225, 222, 206, 1)] hover:text-black hover:bg-[rgba(225, 222, 206, 1)] transition-all duration-300"
                        >
                            <FaInstagram />
                        </a>
                        <a href="https://www.pinterest.com/dhstudiokz/_created/" className="text-2xl p-2 rounded-full border border-[1.5px] border-[rgba(225, 222, 206, 1)] text-[rgba(225, 222, 206, 1)] hover:text-black hover:bg-[rgba(225, 222, 206, 1)] transition-all duration-300"
                        >
                            <FaPinterestP/>
                        </a>

                        <a href="https://www.facebook.com/DHstudioKZ" className="text-2xl p-2 rounded-full border border-[1.5px] border-[rgba(225, 222, 206, 1)] text-[rgba(225, 222, 206, 1)] hover:text-black hover:bg-[rgba(225, 222, 206, 1)] transition-all duration-300"
                        >
                            <FaFacebookF/>
                        </a>

                        <a href="https://vk.com/dh_studio_kz"
                ...
                <div className="">
                    ...
                    <p className="mt-2">Республика Казахстан, 010000,г. Нур-Султан, ул. Достык 13</p>
                    <h3 className="text-lg font-semibold mt-6">Написать на почту</h3>
                    <p className="mt-2">dh.studio.kz@gmail.com</p>
                </div>
                {/* Карта */}
                <div className="container" style={{marginLeft:"150px",marginRight:"-250px"}}>
                    <iframe
            ...
            <div  style={{background: 'rgba(31, 31, 31, 1)'}} >
                <div className="text-left mt-8 text-gray-500 p-5 flex justify-between tect-center" style={{ fontSize: '16px',width: '1170px'}}>
                    <p>© 2021 <a href="#" className="hover:text-white">Все права защищены.<br/>Политика
                        конфиденциальности</a></p>
                    <p>Сайт разработан специально <br/> от <a href="https://mywebstudio.kz"
                                                              className="text-blue-400 hover:text-white">mywebstudio.kz</a>
                    </p>
                </div>
            </div>
        </footer>

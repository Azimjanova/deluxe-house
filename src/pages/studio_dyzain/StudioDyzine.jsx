    ...
    return (
        <div className={'container border'} style={{marginTop: '100px'}}>
            ...
            <div   style={{display: 'flex', justifyContent: 'space-between'}}>
                ...
                <div className={'studioText'} style={{
                    fontSize: '16px',
                    lineHeight: '26px',
                    letterSpacing: '0%',
                    fontFamily: 'Roboto',
                    ...
                    <div className={'studioIcons mt-8'}>
                        <img src={l10et} alt=""/>
                        <img src={l200et} alt=""/>
                        {/*<img src={''} alt=""/>*/}
                    </div>
                    <div className={'studioIcons2'}
                        ...
                        <p style={{fontFamily: '"Segoe Script", cursive', textAlign: 'center',margin: 'auto'}}>Мы создаем
                            прекрасное!</p>
                        <img style={{
                            width: '100px', color: 'white', filter: 'brightness(0) invert(1)',background: 'white'
                        }}
            ...
            <div className={'buttons'}>
                ...
                <button style={{padding: '23px 73px'}} onClick={() => navigate('/remont')}>УСЛУГИ И ЦЕНЫ</button>
            </div>
        </div>
    );
};
